...
binm3 binm3+df update_tmprsadh spfquery
...
ndelay.a case.a sig.a open.a lock.a seek.a getln.a strsalloc.o stralloc.a alloc.a \
...
fs.a auto_qmail.o socket.lib dns.lib
