  ...
  if (spfbehavior && !relayclient)
   { 
    ...
    case SPF_FAIL:
      ...
      substdio_puts(&sslog, "spf: pid ");
      strnum0[fmt_uint(strnum0,(unsigned int) getpid())] = 0;
      substdio_puts(&sslog, strnum0);
      substdio_puts(&sslog, spfbarfmsg.s);
